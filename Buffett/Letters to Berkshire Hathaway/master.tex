...
% 并行排版 + 引用形式
\newenvironment{quoteparallel}[2]
{\begin{Parallel}{}{}\footnotesize\parindent=0pt
    \ParallelLText{\hspace{-0.9em}\textit{#1}}\ParallelRText{\hspace{-0.3em}\textit{#2}}}
{\end{Parallel}}
...
\input{chapters/chapter1957}
\input{chapters/chapter1958}
