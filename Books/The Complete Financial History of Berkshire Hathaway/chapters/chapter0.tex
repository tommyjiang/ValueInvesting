...
\begin{table}[!htbp]
  ...
  \begin{center}
    ...
    \begin{tabular}{ccc}
      ...
      \multicolumn{3}{l}{\makecell[l]{2. Completes the largest retroactive reinsurance deal in history with a \$10.2 billion premium with AIG (2017). \\ 2. 与 AIG 签订了史上最大的追溯再保险合同，保费高达 102 亿美元（2017 年）。}} \\
      \multicolumn{3}{l}{\makecell[l]{3. Buffett wins a ten-year bet that an index fund will beat a group of hedge funds (2017). \\ 3. 巴菲特打赌单个指数基金就能战胜一组对冲基金的组合，他赢了。（2017 年）。}} \\
...
\begin{verseparallel}
  {
    ...
    drivers using smartphones\endnote{The Insurance Information Institute partially corroborated this theory in an October 2016 report.
      ...
      Claims Drive Costs Higher.（The Insurance Information Institute 在 2016 年
      10 月的报告部分证实了这个观点。它引用 National Safety Council 的调查数据，
      74\% 的司机在开车时使用 Facebook，它的标题说明了一切：更多的事故，更多的出
      险导致更多的赔偿）} \endnote{Robert P. Hartwig, James Lynch and Steven Weisbart, “More Accidents, Larger Claims Drive
...
\begin{verseparallel}
  {
    ...
    million stemming from deferred charge amortization. \endnote{The notes to the financial statements state that a \$150 million gain was realized from foreign
      ...
      million premium earned in 2015, if any, would have been trivial.（财报附注
      中指出，1.5 亿利润来自汇率变化，计提的 9000 万亏损与 ultimate liabilities
      有关。500 万保费带来的利润或损失相比之下显得微不足道。）} \\
  }
  {
...
\begin{verseparallel}
  {
    ...
    billion—almost three times depreciation charges.\endnote{Buffett did take
      ...
      to account for it.（巴菲特煞费苦心地指出 GAAP 会计准则会低估铁路公司为了保
      持竞争力所需要的资本支出，为了模拟覆盖这一部分支出，他建议股东将伯克希尔的真实利润
      扣除一些。）} This was as it should be. Berkshire's railroad carried
...
\begin{verseparallel}
  {
    ...
    Lubrizol, IMC (as the parent company of Iscar \endnote{The original business
      was now one of numerous operating units.（前身目前也是子公司之一）}), and
    Marmon were aggregated and discussion squeezed into just a few paragraphs
    along with many other businesses instead of being individually reported.
    Some had previously been public companies that produced annual reports
    hundreds of pages long. Much of that data was now gone as part of
    Berkshire's reporting. Many of the businesses were similar enough that the
    consolidated data was still valuable. The report did identify specific
    businesses where the impact was meaningful, but Berkshire's growth
    diminished the importance
    of individual businesses compared to the whole. \\
  }
  {
    由于这部分业务的公司实在太多，因此将它们分类汇总呈现在报表中是比较合理的。但
    一些分析师渴望获得更多的数据。像 Shaw、Lubrizol、IMC（Iscar 的母公
    司） Marmon 这样的大公司的业务情况被压缩成几段文字，和许多其他业务的数据合并
    在一起而非单独呈现。这些公司里有些以前是上市公司，每年的年报长达数百页。如今，
    这些公司的数据有很大一部分不出现在伯克希尔的年报之中。由于这部分业务涵盖的许
    多公司非常相似，因此整合后的数据仍然有它的价值。虽然年报中明确说明哪些业务对
    伯克希尔有重大影响，但伯克希尔的增长削弱了该业务线中单个公司的重要程度。
  }
\end{verseparallel}
...
\begin{verseparallel}
  ...
  }
  {
    ...
    司，因为它是该细分业务线的最大业务，而且它位于美国之外。这部分业务的需求放缓始
    于 2015 年下半年，预计将持续到 2016 年。
  }
\end{verseparallel}
...
\begin{table}[!htbp]
  ...
  \begin{center}
    ...
    \begin{tabular}{cccccc}
      ...
      \midrule
      \multicolumn{6}{l}{\makecell[l]{脚注：\\ 1. Average capital calculated using specific working capital and fixed asset accounts for
      consistency. Data for \\ 2011 did not contain comparable figures for accrued pension costs and accrued
      postretirement health care costs.}} \\
      \multicolumn{6}{l}{\makecell[l]{1. 平均资本用 specific working capital 和 fixed asset accounts 计算，以保持一致。\\ 2011 年的数据不包括 accrued pension costs 和 accrued consistency。}} \\
      \multicolumn{6}{l}{\makecell[l]{2. Adjustments were made to exclude changes to defined benefit plans.}} \\
      \multicolumn{6}{l}{\makecell[l]{2. 数据有所调整，将 defined benefit plans 排除。}} \\
      \multicolumn{6}{l}{\makecell[l]{3. Heinz capitalization at year-end 2014 consisted of equity (\$7,336), \\ total debt (\$13,597) and
      preferred stock (\$8,320).}} \\
      \multicolumn{6}{l}{\makecell[l]{3. Heinz 2014 年底的财务数据，所有者权益 7,336，债务 13,597，股票 8,320。}} \\
      \multicolumn{6}{l}{\makecell[l]{4. Berkshire invested \$5,260 and 3G invested \$4,740.}} \\
      \multicolumn{6}{l}{\makecell[l]{4. 伯克希尔投入 5,260，3G capital 投入 4,740。}} \\
      \bottomrule
    \end{tabular}
    \caption{Manufacturing, Service, and Retailing businesses --- pre-tax
      earnings \\ 制造业、服务业和零售业税前利润}
